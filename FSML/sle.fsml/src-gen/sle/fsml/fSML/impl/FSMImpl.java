 ...
 * <ul>
 *   <li>{@link sle.fsml.fSML.impl.FSMImpl#getName <em>Name</em>}</li>
...
public class FSMImpl extends MinimalEObjectImpl.Container implements FSM
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FSMLPackage.FSM__NAME, oldName, name));
  }

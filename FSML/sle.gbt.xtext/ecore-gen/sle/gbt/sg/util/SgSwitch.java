 ...
 * @generated
 */
public class SgSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SgPackage.UNARY: {
				Unary unary = (Unary)theEObject;
				T result = caseUnary(unary);
				if (result == null) result = caseSG(unary);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SgPackage.BINARY: {
				Binary binary = (Binary)theEObject;
				T result = caseBinary(binary);
				if (result == null) result = caseSG(binary);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SgPackage.NEGATION: {
				...
				if (result == null) result = caseUnary(negation);
				if (result == null) result = caseSG(negation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SgPackage.UNTIL: {
				...
				if (result == null) result = caseSG(until);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SgPackage.OPTIONAL: {
				...
				if (result == null) result = caseUnary(optional);
				if (result == null) result = caseSG(optional);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SgPackage.PLUS: {
				...
				if (result == null) result = caseUnary(plus);
				if (result == null) result = caseSG(plus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SgPackage.STAR: {
				...
				if (result == null) result = caseUnary(star);
				if (result == null) result = caseSG(star);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SgPackage.ALTERNATIVE: {
				...
				if (result == null) result = caseBinary(alternative);
				if (result == null) result = caseSG(alternative);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SgPackage.SEQUENCE: {
				...
				if (result == null) result = caseBinary(sequence);
				if (result == null) result = caseSG(sequence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SgPackage.ANY: {
				...
				if (result == null) result = caseSG(any);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SgPackage.RANGE: {
				...
				if (result == null) result = caseSG(range);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SgPackage.SINGLE: {
				...
				if (result == null) result = caseSG(single);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SgPackage.REFERENCE: {
				...
				if (result == null) result = caseSG(reference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>SG</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>SG</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSG(SG object) {
		return null;
	}

...
public abstract class AbstractGBTSSyntacticSequencer extends AbstractSyntacticSequencer {

	protected GBTSGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (GBTSGrammarAccess) access;
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_ParenthesizedElement_LeftParenthesisKeyword_0_a.equals(syntax))

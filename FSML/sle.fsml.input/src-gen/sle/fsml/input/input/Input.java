 ...
 * <ul>
 *   <li>{@link sle.fsml.input.input.Input#getName <em>Name</em>}</li>
...
public interface Input extends EObject
{
   ...
   * @see #setName(String)
   * @see sle.fsml.input.input.InputPackage#getInput_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link sle.fsml.input.input.Input#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->

/**
 */
package sle.fsml.input.input.util;
...
public class InputAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected InputSwitch<Adapter> modelSwitch =
    new InputSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseInputEntry(InputEntry object)
      {
  ...
  /**
   * Creates a new adapter for an object of class '{@link sle.fsml.input.input.Input <em>Input</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link sle.fsml.input.input.InputEntry <em>Entry</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->

...
{ before(grammarAccess.getInputAccess().getInputsInputEntryParserRuleCall_2_0_0()); }
	ruleInputEntry{ after(grammarAccess.getInputAccess().getInputsInputEntryParserRuleCall_2_0_0()); }
)
...
{ before(grammarAccess.getInputAccess().getInputsInputEntryParserRuleCall_2_1_1_0()); }
	ruleInputEntry{ after(grammarAccess.getInputAccess().getInputsInputEntryParserRuleCall_2_1_1_0()); }
)
